...
It is possible to set a caption at the end of a block element. A caption may only have one paragraph.
...
and ending the preamble at the start of a following line with `***`.
